...
public class CreateChapterSix {
    ...
    public CreateChapterSix(int chapternumber) {
        this.chapternumber = chapternumber;
    }

    public ArrayList<String> createchaptersixscript() throws MalformedURLException, InterruptedException {
        ArrayList<String> commands = new ArrayList<String>();
        String url = "https://www.linuxfromscratch.org/lfs/view/stable/chapter06/";
        ...
        for(int i = 0; i < chapternumber; i++) {
            ...
            if (packagename.contains("Introduction")) {
                commands.add("#CHAPTER 6 INSTALLATION BEGINS");
